...
class ValidationFlowService:
    ...
    def process_batch(self, payload: ValidationBatchRequest) -> ValidationBatchResponse:
        processed_records = [self._process_record(record) for record in payload.records]
