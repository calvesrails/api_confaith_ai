...
class TwilioVoiceService:
    ...
    def create_outbound_call(
        ...
        *,
        ...
        twilio_from_phone = self._format_e164(self.from_phone_number)
        logger.info(
        ...
        try:
            ...
            logger.exception(
                "Twilio retornou erro HTTP ao criar chamada | batch_id=%s external_id=%s status_code=%s response_body=%s",
                batch_id,
                external_id,
